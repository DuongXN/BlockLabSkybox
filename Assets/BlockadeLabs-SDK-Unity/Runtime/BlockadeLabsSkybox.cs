...
namespace BlockadeLabs_SDK_Unity.Runtime
{
    public class BlockadeLabsSkybox : MonoBehaviour
    {
        ...
        public async Task CreateSkybox(List<SkyboxStyleField> skyboxStyleFields, int id, string drawingData, bool runtime = false)
        {
            isCancelled = false;
            ...
            var createSkyboxObfuscatedId = await ApiRequests.CreateSkybox(skyboxStyleFields, id, apiKey, drawingData);
